...
#     require => File["$dataverse::params::libdir/$dataverse::params::install_dir/dvninstall/answers.txt"]
#  }

# I couldn't get the above to work unless you ran it manually.
# I also had to manually run /etc/glassfish/glassfish/bin/asadmin change-admin-password
# user is admin,password is B10inform@x
# and /etc/glassfish/glassfish/bin/asadmin enable-secure-admin
